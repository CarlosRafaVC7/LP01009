package pe.edu.upeu.LP2_clase01tarea.controller;
...
import pe.edu.upeu.LP2_clase01tarea.service.RolService;
...
public class RolController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Rol> getEmpleadoId(@PathVariable("id") Long id){
		try {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Rol> delEmpleado(@PathVariable("id") Long id){
		try {
	...
	@PutMapping("/{id}")
	public ResponseEntity<?> updateEmpleado(@PathVariable("id") Long id, @Valid @RequestBody Rol emp){
